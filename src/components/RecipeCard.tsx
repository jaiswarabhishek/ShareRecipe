                            ...
                            >
                                ...
                                >
                                    <div className="relative">
                                        ...
                                        >
                                            <Tooltip style="light" animation="duration-500" arrow={false} content="Like" placement="top">
                                                <motion.div
                                            ...
                                            <Tooltip
                                                ...
                                                content={<Share image={recipe.image} name={recipe.name} />}
                                                placement="top"
                                            >
                                                <motion.div
                                                    whileHover={{ scale: 1.3 }}
                                            ...
                                            <Tooltip style="light" animation="duration-500" arrow={false} content="21 min" placement="top">
                                                <motion.div
                                                    whileHover={{ scale: 1.3 }}
                                                    whileTap={{ scale: 0.9 }}
                                                    onClick={e => {
                ...
                <Modal position="center" show={alert} size="md" onClose={() => setAlert(false)} popup>
                    ...
                    <Modal.Body>
                        <div className="text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this Recipe?</h3>
